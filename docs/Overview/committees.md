...
The SPC is a sub-committee of the OC. It is composed of a Chair, who in Europe is the Chair-elect of the EPS-AG Elected Board, and 16 members: eight from the region, and four from each of the other two regions. Further members may be co-opted as necessary, normally the OC/LOC Chairs, the person(s) responsible for the Scientific Secretariat, a further LOC member to ensure good coordination with the LOC, etc.

The job of the SPC is to develop the scientific programme, including the Session on Engagement with Industry, manage the student poster session judging, participate in the light reviewing, decisions concerning potential PR-AB papers, etc.

The eight SPC members from the region, with the role of Session Coordinator, are each responsible for one of the 8 Main Classifications adopted for the scientific programme. Eight further members, 4 from each of the other two regions, act as Shadow, or Deputy Coordinators.
